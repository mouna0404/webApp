(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@angular/router'), require('rxjs/operators'), require('rxjs/internal/operators'), require('@angular/common'), require('@angular/platform-browser/animations'), require('@angular/material/toolbar'), require('@angular/material/list')) :
    typeof define === 'function' && define.amd ? define('mat-breadcrumb', ['exports', '@angular/core', 'rxjs', '@angular/router', 'rxjs/operators', 'rxjs/internal/operators', '@angular/common', '@angular/platform-browser/animations', '@angular/material/toolbar', '@angular/material/list'], factory) :
    (global = global || self, factory(global['mat-breadcrumb'] = {}, global.ng.core, global.rxjs, global.ng.router, global.rxjs.operators, global.rxjs['internal/operators'], global.ng.common, global.ng.platformBrowser.animations, global.ng.material.toolbar, global.ng.material.list));
}(this, (function (exports, core, rxjs, router, operators, operators$1, common, animations, toolbar, list) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var MatBreadcrumbService = /** @class */ (function () {
        ...
        MatBreadcrumbService.ɵprov = core.ɵɵdefineInjectable({ factory: function MatBreadcrumbService_Factory() { return new MatBreadcrumbService(); }, token: MatBreadcrumbService, providedIn: "root" });
    ...
    var MatBreadcrumbComponent = /** @class */ (function () {
        ...
        MatBreadcrumbComponent.prototype.breadCrumbData = function () {
            ...
            this.router.events
                ...
                .pipe(operators$1.map(function () { return _this.activatedRoute; }))
                .pipe(operators$1.map(function (route) {
    ...
    exports.MatBreadcrumbComponent = MatBreadcrumbComponent;
    exports.MatBreadcrumbModule = MatBreadcrumbModule;
    exports.MatBreadcrumbService = MatBreadcrumbService;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=mat-breadcrumb.umd.js.map
